...
- With a header, the toolbar is docked into it (`.tpl-toolbar` inside `.tpl-header`) instead of floating over the page, so lay the header out for a row that wraps: brand, links, toolbar.
