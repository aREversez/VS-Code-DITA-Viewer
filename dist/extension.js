...
<pre>${Yt(m)}</pre>
...
</html>`}}};function Yt(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function it(e){return e.replace(/<\/script>/gi,"<\\/script>")}function Re(e){let t=[],i=(0,N.dirname)(e.fsPath),r=Le(i),s=i;for(;s.length>=r.length;){try{for(let p of(0,O.readdirSync)(s))p.endsWith(".ditamap")&&t.push((0,N.join)(s,p))}catch{}if(t.length>0)return t;let d=(0,N.dirname)(s);if(d===s)break;s=d}return t}function rt(e){return e.type==="text"?e.text||"":(e.children||[]).map(rt).join("")}function jt(e,t){for(let i of t){let r=(e.children||[]).find(s=>s.type==="element"&&s.baseType===i);if(r){let s=rt(r).trim();if(s)return s}}}function Xt(e){let t=(e.children||[]).find(i=>i.type==="element"&&i.baseType==="map/topicmeta");if(t)return jt(t,["map/keyword","map/linktext","map/navtitle","map/shortdesc"])}function Ie(e){let t=new Map,i=Re(e);for(let s of i)try{let m=function(f){if(f.type!=="element")return;let g=f.baseType;if((g==="map/topicref"||g==="map/keydef")&&f.attributes?.keys){let w=f.attributes.keys,b=Xt(f);t.set(w,b||w)}for(let w of f.children||[])m(w)};var r=m;let d=(0,O.readFileSync)(s,"utf-8"),u=oe(K(d)).root;for(let f of u.children||[])m(f)}catch{}return t}function Kt(e){let t={},i=new Set,r=f=>{let g=(0,N.basename)(f);if(!i.has(g)&&(0,O.existsSync)(f))try{t[g]=(0,O.readFileSync)(f,"utf-8"),i.add(g)}catch{}},s=(0,N.dirname)(e.fsPath),d=Le(s),p=Qt(s),u=new Set;u.add(p),d!==p&&u.add(d);try{let g=T.workspace.getConfiguration("dita-viewer").get("cssDirectory");if(g)for(let w of g){let b=Jt(w,s);b&&(0,O.existsSync)(b)&&!u.has(b)&&u.add(b)}}catch{}for(let f of u)try{for(let g of(0,O.readdirSync)(f))g.toLowerCase().endsWith(".css")&&r((0,N.join)(f,g))}catch{}try{let g=T.workspace.getConfiguration("dita-viewer").get("customCss");if(g)for(let w of g){let b=Zt(w,s);b&&r(b)}}catch{}let m=t["custom.css"]?"custom.css":Object.keys(t)[0]||"";return{files:t,defaultName:m}}function Qt(e){let t=Le(e),i=e;for(;i.length>=t.length;){if((0,O.existsSync)((0,N.join)(i,"custom.css")))return i;let r=(0,N.dirname)(i);if(r===i)break;i=r}return e}function Le(e){let t=T.workspace.workspaceFolders;if(t&&t.length>0)return t[0].uri.fsPath;let i=e.includes("/")?"/":"\\",r=e.split(/[\\/]/);return i==="/"?"/"+r.slice(1,2).join("/"):r.length>2?r.slice(0,2).join("\\"):e}function Zt(e,t){if((0,N.isAbsolute)(e)&&(0,O.existsSync)(e))return e;let i=(0,N.resolve)(t,e);if((0,O.existsSync)(i))return i;let r=T.workspace.workspaceFolders;if(r)for(let s of r){let d=(0,N.resolve)(s.uri.fsPath,e);if((0,O.existsSync)(d))return d}}function Jt(e,t){if((0,N.isAbsolute)(e))return(0,O.existsSync)(e)?e:void 0;let i=(0,N.resolve)(t,e);if((0,O.existsSync)(i))return i;let r=T.workspace.workspaceFolders;if(r)for(let s of r){let d=(0,N.resolve)(s.uri.fsPath,e);if((0,O.existsSync)(d))return d}}var B=me(require("vscode"));function re(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function st(e,t){return t==null?"":` ${e}="${re(t)}"`}function ie(e,t){return e.attributes?.[t]}function ye(e){return e.type==="text"?e.text||"":(e.children||[]).map(ye).join("")}function at(e,t){for(let i of t){let r=(e.children||[]).find(s=>s.type==="element"&&s.baseType===i);if(r){let s=ye(r).trim();if(s)return s}}}function Oe(e){let t=ie(e,"keys"),i=ie(e,"href"),r=(e.children||[]).find(s=>s.type==="element"&&s.baseType==="map/topicmeta");if(r){let s=at(r,["map/navtitle","map/linktext","map/shortdesc"]);if(s)return s;let d=r.children.find(p=>p.type==="element"&&p.baseType==="map/keywords");if(d){let p=at(d,["map/keyword"]);if(p)return p}}if(i){let s=i.replace(/\\/g,"/").split("/"),d=s[s.length-1]||"",p=d.lastIndexOf(".");return p>0?d.substring(0,p):d}return t||"(unnamed)"}function en(e){return!!ie(e,"href")}function pe(e,t,i){return(e.children||[]).filter(r=>r.type==="element").map(r=>i(r,t)).join("")}function ct(e,t,i){let r=ie(e,"href")||"",s=ie(e,"keys")||"",d=Oe(e),p=en(e),u=pe(e,t,i),m=p?'<span class="map-tree-icon map-tree-icon--file">\u{1F4C4}</span>':'<span class="map-tree-icon map-tree-icon--key">\u{1F511}</span>',f=re(d),g=st("data-keys",s),w=r?st("data-href",r):"";return p?`<li class="map-tree-item map-tree-item--nav"${g}${w}>
      <a href="#" class="map-tree-link" data-href="${re(r)}">${m}<span class="map-tree-label">${f}</span></a>
    ...
    ${u?`<ul class="map-tree">${u}</ul>`:""}
  </li>`}var tn={"map/map":(e,t,i)=>{let r=e.children.find(u=>u.type==="element"&&u.baseType==="map/map-title"),s=r?`<h1 class="map-title">${re(ye(r))}</h1>`:"",p=e.children.filter(u=>u.type!=="element"||u.baseType!=="map/map-title").filter(u=>u.type==="element").map(u=>i(u,t)).join("");return`<div class="ditamap-container">
      ${s}
      <ul class="map-tree">${p}</ul>
    </div>`},"map/map-title":(e,t,i)=>`<h1 class="map-title">${re(ye(e))}</h1>`,"map/topicref":ct,"map/topichead":(e,t,i)=>{let r=Oe(e),s=pe(e,t,i);return`<li class="map-tree-item map-tree-item--head">
      ...
      <ul class="map-tree">${pe(e,t,i)}</ul>
    </li>`,"map/keydef":ct,"map/reltable":(e,t,i)=>`<div class="map-reltable"><h2 class="map-reltable-title">Related Information</h2>
    ...
    </div>`,"map/relheader":(e,t,i)=>`<tr class="relheader">${e.children.filter(s=>s.type==="element"&&s.baseType==="map/relcell").map(s=>i(s,t)).map(s=>`<th>${s}</th>`).join("")}</tr>`,"map/relrow":(e,t,i)=>`<tr class="relrow">${e.children.filter(s=>s.type==="element"&&s.baseType==="map/relcell").map(s=>i(s,t)).map(s=>`<td>${s}</td>`).join("")}</tr>`,"map/relcell":(e,t,i)=>`<span class="relcell-content"><ul class="map-tree map-tree--inline">${pe(e,t,i)}</ul></span>`,"map/relcolspec":()=>"","map/topicmeta":()=>"","map/linktext":()=>"","map/navtitle":()=>"","map/shortdesc":()=>"","map/keywords":()=>"","map/keyword":()=>"","map/anchor":()=>"","map/navref":()=>"","map/mapref":()=>""};function Te(e,t,i){if(e.type!=="element")return;let r=e.baseType;if(r!=="map/reltable")if(r==="map/topicref"||r==="map/keydef"||r==="map/topichead"){let s=ie(e,"href"),d=ie(e,"keys");i.push({href:s,displayName:Oe(e),depth:t,keys:d});for(let p of e.children||[])Te(p,t+1,i)}else if(r==="map/topicgroup")for(let s of e.children||[])Te(s,t,i);else for(let s of e.children||[])Te(s,t,i)}function lt(e){let t=[];for(let i of e.children||[])Te(i,0,t);return t}function dt(e,t){function i(s,d){if(s.type==="text")return"";let p=s.baseType,u=p?tn[p]:void 0;return u?u(s,d,i):pe(s,d,i)}let r={docDir:t.docDir};return i(e,r)}var G=require("path"),pt=require("crypto"),we=require("fs");function nn(){return`
(function() {
  var vscode = acquireVsCodeApi();
...
</html>`}}renderBookContent(t,i,r,s){let d=lt(t),p=Ie(i.uri),u=new Set,m=[];for(let f of d)if(f.href){let g=(0,G.resolve)(s,f.href);if(u.has(g)){m.push(tt(f.href));continue}u.add(g);let w=(0,G.dirname)(g),b=y=>{try{let E=(0,G.resolve)(w,y),x=B.Uri.file(E),D=r.asWebviewUri(x);if(D)return D.toString()}catch{}try{let E=(0,G.resolve)(w,y);if((0,we.existsSync)(E)){let x=(0,we.readFileSync)(E),D=y.toLowerCase().split(".").pop()||"";return`data:${D==="png"?"image/png":D==="jpg"||D==="jpeg"?"image/jpeg":D==="gif"?"image/gif":D==="svg"?"image/svg+xml":D==="webp"?"image/webp":"image/png"};base64,${x.toString("base64")}`}}catch{}return""},A=Math.min(1+f.depth,6),h=nt({filePath:g,keyMap:p,asWebviewUri:b,headingLevel:A});h.error?m.push(et(f.displayName,h.error,f.depth)):m.push(`<div class="book-entry">${h.html}</div>`)}else m.push(Je(f.displayName,f.depth));return`<div class="ditamap-book">${m.join(`
`)}</div>`}};function ut(e){if(e.configuredPath){let t=e.configuredPath.trim();if(e.fileExists(t))return{found:!0,location:{executablePath:t,source:"setting"}};let i=e.platform==="win32"?`${t}\\bin\\dita.bat`:`${t}/bin/dita`;return e.fileExists(i)?{found:!0,location:{executablePath:i,source:"setting"}}:{found:!1,reason:"setting-invalid"}}if(e.ditaHomeEnv){let t=e.platform==="win32"?`${e.ditaHomeEnv}\\bin\\dita.bat`:`${e.ditaHomeEnv}/bin/dita`;if(e.fileExists(t))return{found:!0,location:{executablePath:t,source:"env"}}}if(e.pathEnv){let t=e.platform==="win32"?";":":",i=e.pathEnv.split(t),r=e.platform==="win32"?"dita.bat":"dita";for(let s of i){if(!s)continue;let d=`${s}/${r}`.replace(/\\/g,"/");if(e.fileExists(d))return{found:!0,location:{executablePath:d,source:"path"}}}}return{found:!1,reason:"not-found"}}function ft(e){return["-i",e.mapPath,"-f",e.transtype,"-o",e.outputDir]}var on=/^.*?\[ERROR\]/i,rn=/^.*?\[WARN\]/i;function Me(e){return on.test(e)?"error":rn.test(e)?"warn":"info"}function mt(){let e="";return{processChunk(t){e+=t;let i=e.split(`
`);return e=i.pop()||"",i},flush(){let t=e;return e="",t?[t]:[]}}}var sn="ditaViewer.transformWithDitaOt";function an(e){e.subscriptions.push(v.window.registerCustomEditorProvider("ditaViewer.preview",new be(e),{webviewOptions:{retainContextWhenHidden:!0}})),e.subscriptions.push(v.window.registerCustomEditorProvider("ditaViewer.mapPreview",new Ee(e),{webviewOptions:{retainContextWhenHidden:!0}}));let t=v.commands.registerCommand("ditaViewer.showRendered",()=>{let s=v.window.activeTextEditor;s&&v.commands.executeCommand("vscode.openWith",s.document.uri,"ditaViewer.preview",v.ViewColumn.Beside)});e.subscriptions.push(t);let i=v.commands.registerCommand("ditaViewer.showMapRendered",()=>{let s=v.window.activeTextEditor;s&&v.commands.executeCommand("vscode.openWith",s.document.uri,"ditaViewer.mapPreview",v.ViewColumn.Beside)});e.subscriptions.push(i);let r=v.commands.registerCommand(sn,async()=>{let s=new v.CancellationTokenSource,d=[];try{let p=await cn();if(!p){v.window.showErrorMessage("\u8BF7\u5148\u6253\u5F00\u4E00\u4E2A .ditamap \u6587\u4EF6\u3002");return}let u=v.workspace.getConfiguration("dita-viewer").get("ditaOtPath"),m=u&&u.trim()?u.trim():void 0,f=ut({configuredPath:m,ditaHomeEnv:process.env.DITA_HOME,pathEnv:process.env.PATH,platform:process.platform,fileExists:x=>(0,se.existsSync)(x)});if(!f.found){f.reason==="setting-invalid"?await v.window.showErrorMessage(`\u914D\u7F6E\u7684 DITA-OT \u8DEF\u5F84\u65E0\u6548\uFF1A${m} \u4E0B\u672A\u627E\u5230 dita \u53EF\u6267\u884C\u6587\u4EF6\u3002`,"\u6253\u5F00\u8BBE\u7F6E")==="\u6253\u5F00\u8BBE\u7F6E"&&v.commands.executeCommand("workbench.action.openSettings","dita-viewer.ditaOtPath"):await v.window.showErrorMessage("\u672A\u627E\u5230 DITA-OT\u3002\u8BF7\u5B89\u88C5 DITA-OT \u6216\u914D\u7F6E DITA_HOME \u73AF\u5883\u53D8\u91CF\u3002","\u67E5\u770B\u5B89\u88C5\u8BF4\u660E")==="\u67E5\u770B\u5B89\u88C5\u8BF4\u660E"&&v.env.openExternal(v.Uri.parse("https://www.dita-ot.org/documentation/installing"));return}let g=[{label:"html5",description:"HTML5 (\u9ED8\u8BA4)"},{label:"pdf",description:"PDF"},{label:"xhtml",description:"XHTML"},{label:"markdown",description:"Markdown"}],w=await v.window.showQuickPick(g,{placeHolder:"\u9009\u62E9\u8F93\u51FA\u683C\u5F0F\uFF08transtype\uFF09"});if(!w)return;let b=w.label,A=(0,ue.dirname)(p.fsPath),h=(0,ue.join)(A,"out",b);if((0,se.existsSync)(h))try{if((0,se.readdirSync)(h).length>0&&await v.window.showWarningMessage(`\u8F93\u51FA\u76EE\u5F55\u5DF2\u5B58\u5728\u4E14\u975E\u7A7A\uFF1A${h}\u3002\u662F\u5426\u8986\u76D6\uFF1F`,{modal:!0},"\u8986\u76D6")!=="\u8986\u76D6")return}catch{}let y=ft({mapPath:p.fsPath,transtype:b,outputDir:h}),E=v.window.createOutputChannel("DITA-OT Transform");d.push(v.Disposable.from({dispose:()=>E.dispose()},{dispose:()=>s.dispose()})),E.show(!0),await v.window.withProgress({location:v.ProgressLocation.Notification,title:`DITA-OT: \u6B63\u5728\u8F6C\u6362\u4E3A ${b}\uFF08\u9996\u6B21\u8F6C\u6362\u53EF\u80FD\u9700\u8981\u8F83\u957F\u65F6\u95F4\uFF09`,cancellable:!0},async(x,D)=>(D.onCancellationRequested(()=>{s.token.isCancellationRequested||s.cancel()}),new Promise((Q,k)=>{let V=(0,gt.spawn)(f.location.executablePath,y,{shell:!1}),J=!1,z=s.token.onCancellationRequested(()=>{J=!0,V.kill("SIGTERM"),setTimeout(()=>{try{V.kill("SIGKILL")}catch{}},3e3)});d.push(z);let Z=0,c=mt();V.stdout?.on("data",U=>{E.append(U.toString())}),V.stderr?.on("data",U=>{let F=U.toString();E.append(F);let M=c.processChunk(F);for(let Y of M)Me(Y)==="error"&&Z++}),V.on("error",U=>{E.appendLine(`
[DITA-OT] \u8FDB\u7A0B\u542F\u52A8\u5931\u8D25: ${U.message}`),k(U)}),V.on("close",async U=>{for(let M of c.flush())Me(M)==="error"&&Z++;if(J){E.appendLine(`
