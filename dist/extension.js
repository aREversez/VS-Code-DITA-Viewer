...
<pre>${tn(g)}</pre>
...
</html>`}}};function tn(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function dt(e){return e.replace(/<\/script>/gi,"<\\/script>")}function Ue(e){let t=[],i=(0,A.dirname)(e.fsPath),r=Ve(i),s=i;for(;s.length>=r.length;){try{for(let p of(0,U.readdirSync)(s))p.endsWith(".ditamap")&&t.push((0,A.join)(s,p))}catch{}if(t.length>0)return t;let l=(0,A.dirname)(s);if(l===s)break;s=l}return t}function Be(e){return e.type==="text"?e.text||"":(e.children||[]).map(Be).join("")}function nn(e,t){for(let i of t){let r=(e.children||[]).find(l=>l.type==="element"&&l.baseType===i);if(r){let l=Be(r).trim();if(l)return l}let s=(e.children||[]).find(l=>l.type==="element"&&l.baseType==="map/keywords");if(s){let l=(s.children||[]).find(p=>p.type==="element"&&p.baseType===i);if(l){let p=Be(l).trim();if(p)return p}}}}function on(e){let t=(e.children||[]).find(i=>i.type==="element"&&i.baseType==="map/topicmeta");if(t)return nn(t,["map/keyword","map/linktext","map/navtitle","map/shortdesc"])}function He(e){let t=new Map,i=Ue(e);for(let s of i)try{let g=function(m){if(m.type!=="element")return;let f=m.baseType;if((f==="map/topicref"||f==="map/keydef")&&m.attributes?.keys){let w=m.attributes.keys,v=on(m);t.set(w,v||w)}for(let w of m.children||[])g(w)};var r=g;let l=(0,U.readFileSync)(s,"utf-8"),u=re(Q(l)).root;he(u,(0,A.dirname)(s));for(let m of u.children||[])g(m)}catch{}return t}function rn(e){let t={},i=new Set,r=m=>{let f=(0,A.basename)(m);if(!i.has(f)&&(0,U.existsSync)(m))try{t[f]=(0,U.readFileSync)(m,"utf-8"),i.add(f)}catch{}},s=(0,A.dirname)(e.fsPath),l=Ve(s),p=sn(s),u=new Set;u.add(p),l!==p&&u.add(l);try{let f=x.workspace.getConfiguration("dita-viewer").get("cssDirectory");if(f)for(let w of f){let v=cn(w,s);v&&(0,U.existsSync)(v)&&!u.has(v)&&u.add(v)}}catch{}for(let m of u)try{for(let f of(0,U.readdirSync)(m))f.toLowerCase().endsWith(".css")&&r((0,A.join)(m,f))}catch{}try{let f=x.workspace.getConfiguration("dita-viewer").get("customCss");if(f)for(let w of f){let v=an(w,s);v&&r(v)}}catch{}let g=t["custom.css"]?"custom.css":Object.keys(t)[0]||"";return{files:t,defaultName:g}}function sn(e){let t=Ve(e),i=e;for(;i.length>=t.length;){if((0,U.existsSync)((0,A.join)(i,"custom.css")))return i;let r=(0,A.dirname)(i);if(r===i)break;i=r}return e}function Ve(e){let t=x.workspace.workspaceFolders;if(t&&t.length>0)return t[0].uri.fsPath;let i=e.includes("/")?"/":"\\",r=e.split(/[\\/]/);return i==="/"?"/"+r.slice(1,2).join("/"):r.length>2?r.slice(0,2).join("\\"):e}function an(e,t){if((0,A.isAbsolute)(e)&&(0,U.existsSync)(e))return e;let i=(0,A.resolve)(t,e);if((0,U.existsSync)(i))return i;let r=x.workspace.workspaceFolders;if(r)for(let s of r){let l=(0,A.resolve)(s.uri.fsPath,e);if((0,U.existsSync)(l))return l}}function cn(e,t){if((0,A.isAbsolute)(e))return(0,U.existsSync)(e)?e:void 0;let i=(0,A.resolve)(t,e);if((0,U.existsSync)(i))return i;let r=x.workspace.workspaceFolders;if(r)for(let s of r){let l=(0,A.resolve)(s.uri.fsPath,e);if((0,U.existsSync)(l))return l}}var V=ye(require("vscode"));function de(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function mt(e,t){return t==null?"":` ${e}="${de(t)}"`}function le(e,t){return e.attributes?.[t]}function Ce(e){return e.type==="text"?e.text||"":(e.children||[]).map(Ce).join("")}function gt(e,t){for(let i of t){let r=(e.children||[]).find(s=>s.type==="element"&&s.baseType===i);if(r){let s=Ce(r).trim();if(s)return s}}}function We(e){let t=le(e,"keys"),i=le(e,"href"),r=(e.children||[]).find(s=>s.type==="element"&&s.baseType==="map/topicmeta");if(r){let s=gt(r,["map/navtitle","map/linktext","map/shortdesc"]);if(s)return s;let l=r.children.find(p=>p.type==="element"&&p.baseType==="map/keywords");if(l){let p=gt(l,["map/keyword"]);if(p)return p}}if(i){let s=i.replace(/\\/g,"/").split("/"),l=s[s.length-1]||"",p=l.lastIndexOf(".");return p>0?l.substring(0,p):l}return t||"(unnamed)"}function ln(e){return!!le(e,"href")}function ve(e,t,i){return(e.children||[]).filter(r=>r.type==="element").map(r=>i(r,t)).join("")}function ht(e,t,i){let r=le(e,"href")||"",s=le(e,"keys")||"",l=We(e),p=ln(e),u=ve(e,t,i),g=p?'<span class="map-tree-icon map-tree-icon--file">\u{1F4C4}</span>':'<span class="map-tree-icon map-tree-icon--key">\u{1F511}</span>',m=de(l),f=mt("data-keys",s),w=r?mt("data-href",r):"";return p?`<li class="map-tree-item map-tree-item--nav"${f}${w}>
    ...
    ${u?`<ul class="map-tree">${u}</ul>`:""}
  </li>`}var dn={"map/map":(e,t,i)=>{let r=e.children.find(u=>u.type==="element"&&u.baseType==="map/map-title"),s=r?`<h1 class="map-title">${de(Ce(r))}</h1>`:"",p=e.children.filter(u=>u.type!=="element"||u.baseType!=="map/map-title").filter(u=>u.type==="element").map(u=>i(u,t)).join("");return`<div class="ditamap-container">
      ${s}
      <ul class="map-tree">${p}</ul>
    </div>`},"map/map-title":(e,t,i)=>`<h1 class="map-title">${de(Ce(e))}</h1>`,"map/topicref":ht,"map/topichead":(e,t,i)=>{let r=We(e),s=ve(e,t,i);return`<li class="map-tree-item map-tree-item--head">
    ...
    </div>`,"map/relheader":(e,t,i)=>`<tr class="relheader">${e.children.filter(s=>s.type==="element"&&s.baseType==="map/relcell").map(s=>i(s,t)).map(s=>`<th>${s}</th>`).join("")}</tr>`,"map/relrow":(e,t,i)=>`<tr class="relrow">${e.children.filter(s=>s.type==="element"&&s.baseType==="map/relcell").map(s=>i(s,t)).map(s=>`<td>${s}</td>`).join("")}</tr>`,"map/relcell":(e,t,i)=>`<span class="relcell-content"><ul class="map-tree map-tree--inline">${ve(e,t,i)}</ul></span>`,"map/relcolspec":()=>"","map/topicmeta":()=>"","map/linktext":()=>"","map/navtitle":()=>"","map/shortdesc":()=>"","map/keywords":()=>"","map/keyword":()=>"","map/anchor":()=>"","map/navref":()=>"","map/mapref":()=>""};function Se(e,t,i){if(e.type!=="element")return;let r=e.baseType;if(r!=="map/reltable")if(r==="map/topicref"||r==="map/keydef"||r==="map/topichead"){let s=le(e,"href"),l=le(e,"keys");i.push({href:s,displayName:We(e),depth:t,keys:l});for(let p of e.children||[])Se(p,t+1,i)}else if(r==="map/topicgroup")for(let s of e.children||[])Se(s,t,i);else for(let s of e.children||[])Se(s,t,i)}function Ne(e){let t=[];for(let i of e.children||[])Se(i,0,t);return t}function vt(e,t){function i(s,l){if(s.type==="text")return"";let p=s.baseType,u=p?dn[p]:void 0;return u?u(s,l,i):ve(s,l,i)}let r={docDir:t.docDir};return i(e,r)}var Y=require("path"),bt=require("crypto"),ke=require("fs"),Tt=new Map;function yt(e){return Tt.get(e)}function pn(){return`
(function() {
  var vscode = acquireVsCodeApi();
...
</html>`}}renderBookContent(t,i,r,s){let l=Ne(t),p=He(i.uri),u=new Set,g=[];for(let m of l)if(m.href){let f=(0,Y.resolve)(s,m.href);if(u.has(f)){g.push(ct(m.href));continue}u.add(f);let w=(0,Y.dirname)(f),v=D=>{try{let T=(0,Y.resolve)(w,D),b=V.Uri.file(T),y=r.asWebviewUri(b);if(y)return y.toString()}catch{}try{let T=(0,Y.resolve)(w,D);if((0,ke.existsSync)(T)){let b=(0,ke.readFileSync)(T),y=D.toLowerCase().split(".").pop()||"";return`data:${y==="png"?"image/png":y==="jpg"||y==="jpeg"?"image/jpeg":y==="gif"?"image/gif":y==="svg"?"image/svg+xml":y==="webp"?"image/webp":"image/png"};base64,${b.toString("base64")}`}}catch{}return""},N=Math.min(1+m.depth,6),_=lt({filePath:f,keyMap:p,asWebviewUri:v,headingLevel:N});_.error?g.push(at(m.displayName,_.error,m.depth)):g.push(`<div class="book-entry">${_.html}</div>`)}else g.push(st(m.displayName,m.depth));return`<div class="ditamap-book">${g.join(`
`)}</div>`}};var wt=require("fs"),_e=require("path");function Et(e){let t=(0,wt.readFileSync)(e,"utf-8"),i=re(Q(t));return Ne(i.root).filter(s=>s.href&&s.href.toLowerCase().endsWith(".dita")).map(s=>({file:(0,_e.basename)(s.href,(0,_e.extname)(s.href))+".html",title:s.displayName}))}function xt(e){if(e.configuredPath){let t=e.configuredPath.trim();if(e.fileExists(t))return{found:!0,location:{executablePath:t,source:"setting"}};let i=e.platform==="win32"?`${t}\\bin\\dita.bat`:`${t}/bin/dita`;return e.fileExists(i)?{found:!0,location:{executablePath:i,source:"setting"}}:{found:!1,reason:"setting-invalid"}}if(e.ditaHomeEnv){let t=e.platform==="win32"?`${e.ditaHomeEnv}\\bin\\dita.bat`:`${e.ditaHomeEnv}/bin/dita`;if(e.fileExists(t))return{found:!0,location:{executablePath:t,source:"env"}}}if(e.pathEnv){let t=e.platform==="win32"?";":":",i=e.pathEnv.split(t),r=e.platform==="win32"?"dita.bat":"dita";for(let s of i){if(!s)continue;let l=`${s}/${r}`.replace(/\\/g,"/");if(e.fileExists(l))return{found:!0,location:{executablePath:l,source:"path"}}}}return{found:!1,reason:"not-found"}}function Dt(e){let t=["-i",e.mapPath,"-f",e.transtype,"-o",e.outputDir,"--nav-toc=full"];return e.cssArg&&(t.push("--args.css",e.cssArg.filename),t.push("--args.cssroot",e.cssArg.root),t.push("--args.copycss","yes"),t.push("--args.csspath","css")),e.ditavalFile&&t.push("--filter",e.ditavalFile),t}var un=/^.*?\[ERROR\]/i,fn=/^.*?\[WARN\]/i;function ze(e){return un.test(e)?"error":fn.test(e)?"warn":"info"}function St(){let e="";return{processChunk(t){e+=t;let i=e.split(`
`);return e=i.pop()||"",i},flush(){let t=e;return e="",t?[t]:[]}}}var mn="ditaViewer.transformWithDitaOt";function gn(e){e.subscriptions.push(h.window.registerCustomEditorProvider("ditaViewer.preview",new De(e),{webviewOptions:{retainContextWhenHidden:!0}})),e.subscriptions.push(h.window.registerCustomEditorProvider("ditaViewer.mapPreview",new Ae(e),{webviewOptions:{retainContextWhenHidden:!0}}));let t=h.commands.registerCommand("ditaViewer.showRendered",()=>{let l=h.window.activeTextEditor;l&&h.commands.executeCommand("vscode.openWith",l.document.uri,"ditaViewer.preview",h.ViewColumn.Beside)});e.subscriptions.push(t);let i=h.commands.registerCommand("ditaViewer.showMapRendered",()=>{let l=h.window.activeTextEditor;l&&h.commands.executeCommand("vscode.openWith",l.document.uri,"ditaViewer.mapPreview",h.ViewColumn.Beside)});e.subscriptions.push(i);let r=e.extensionPath,s=h.commands.registerCommand(mn,async()=>{let l=new h.CancellationTokenSource,p=[];try{let u=await bn();if(!u){h.window.showErrorMessage("\u8BF7\u5148\u6253\u5F00\u4E00\u4E2A .ditamap \u6587\u4EF6\u3002");return}let g=Ge(u.fsPath),m=(0,k.dirname)(g),f=h.workspace.getConfiguration("dita-viewer").get("ditaOtPath"),w=f&&f.trim()?f.trim():void 0,v=xt({configuredPath:w,ditaHomeEnv:process.env.DITA_HOME,pathEnv:process.env.PATH,platform:process.platform,fileExists:c=>(0,I.existsSync)(c)});if(!v.found){v.reason==="setting-invalid"?await h.window.showErrorMessage(`\u914D\u7F6E\u7684 DITA-OT \u8DEF\u5F84\u65E0\u6548\uFF1A${w} \u4E0B\u672A\u627E\u5230 dita \u53EF\u6267\u884C\u6587\u4EF6\u3002`,"\u6253\u5F00\u8BBE\u7F6E")==="\u6253\u5F00\u8BBE\u7F6E"&&h.commands.executeCommand("workbench.action.openSettings","dita-viewer.ditaOtPath"):await h.window.showErrorMessage("\u672A\u627E\u5230 DITA-OT\u3002\u8BF7\u5B89\u88C5 DITA-OT \u6216\u914D\u7F6E DITA_HOME \u73AF\u5883\u53D8\u91CF\u3002","\u67E5\u770B\u5B89\u88C5\u8BF4\u660E")==="\u67E5\u770B\u5B89\u88C5\u8BF4\u660E"&&h.env.openExternal(h.Uri.parse("https://www.dita-ot.org/documentation/installing"));return}let N=[{label:"html5",description:"HTML5 (\u9ED8\u8BA4)"},{label:"pdf",description:"PDF"},{label:"xhtml",description:"XHTML"},{label:"markdown",description:"Markdown"}],_=await h.window.showQuickPick(N,{placeHolder:"\u9009\u62E9\u8F93\u51FA\u683C\u5F0F\uFF08transtype\uFF09"});if(!_)return;let D=_.label,T=(0,k.join)(m,"out",D),b=await h.window.showOpenDialog({canSelectFolders:!0,canSelectFiles:!1,canSelectMany:!1,defaultUri:h.Uri.file(T),openLabel:"\u9009\u62E9\u8F93\u51FA\u76EE\u5F55"}),y=Ge(b&&b.length>0?b[0].fsPath:T);if((0,I.existsSync)(y))try{if((0,I.readdirSync)(y).length>0&&await h.window.showWarningMessage(`\u8F93\u51FA\u76EE\u5F55\u5DF2\u5B58\u5728\u4E14\u975E\u7A7A\uFF1A${y}\u3002\u662F\u5426\u8986\u76D6\uFF1F`,{modal:!0},"\u8986\u76D6")!=="\u8986\u76D6")return}catch{}let Z;if(D==="html5"||D==="xhtml"){let c=vn(m);if(c.length>0){let q=[{label:"$(close) \u4E0D\u6DFB\u52A0\u81EA\u5B9A\u4E49 CSS",description:"\u4F7F\u7528 DITA-OT \u9ED8\u8BA4\u6837\u5F0F",css:void 0},...c.map(M=>({label:`$(file) ${(0,k.basename)(M)}`,description:(0,k.dirname)(M),css:{filename:(0,k.basename)(M),root:(0,k.dirname)(M)}}))],O=await h.window.showQuickPick(q,{placeHolder:"\u9009\u62E9\u81EA\u5B9A\u4E49 CSS \u6587\u4EF6\uFF08\u53EF\u9009\uFF09",ignoreFocusOut:!1});O&&O.css&&(Z=O.css)}}let S,X=await h.window.showOpenDialog({canSelectFiles:!0,canSelectFolders:!1,canSelectMany:!1,filters:{"DITAVAL \u7B5B\u9009\u6587\u4EF6":["ditaval"]},openLabel:"\u9009\u62E9\u7B5B\u9009\u6587\u4EF6"});X&&X.length>0&&(S=Ge(X[0].fsPath));let ee;if(D==="html5"||D==="xhtml"){let c=[{label:"\u5BFC\u822A\u5DE5\u5177\u680F",description:"\u4E0A\u4E00\u9875/\u4E0B\u4E00\u9875 + \u6298\u53E0/\u5C55\u5F00\u7AE0\u8282",key:"navToolbar",picked:!0},{label:"\u4FA7\u8FB9\u680F\u76EE\u5F55",description:"\u5DE6\u4FA7\u56FA\u5B9A\u76EE\u5F55\u6811",key:"sidebar",picked:!0},{label:"\u672C\u9875\u76EE\u5F55",description:"\u53F3\u4FA7\u672C\u9875\u6807\u9898\u5BFC\u822A",key:"onPageToc",picked:!0},{label:"\u4EE3\u7801\u590D\u5236\u6309\u94AE",description:"\u4EE3\u7801\u5757\u590D\u5236\u6309\u94AE",key:"copyCode",picked:!0},{label:"\u56DE\u5230\u9876\u90E8",description:"\u53F3\u4E0B\u89D2\u56DE\u5230\u9876\u90E8\u6309\u94AE",key:"backToTop",picked:!0},{label:"\u6697\u8272\u6A21\u5F0F",description:"\u4EAE\u8272/\u6697\u8272\u5207\u6362",key:"darkMode",picked:!0}],q=await h.window.showQuickPick(c,{canPickMany:!0,placeHolder:"\u9009\u62E9\u8981\u542F\u7528\u7684\u7AD9\u70B9\u589E\u5F3A\u529F\u80FD\uFF08\u9ED8\u8BA4\u5168\u90E8\u542F\u7528\uFF09",ignoreFocusOut:!1});if(q){let O={navToolbar:!1,sidebar:!1,onPageToc:!1,copyCode:!1,backToTop:!1,darkMode:!1};for(let M of q)O[M.key]=!0;ee=O}else ee={navToolbar:!0,sidebar:!0,onPageToc:!0,copyCode:!0,backToTop:!0,darkMode:!0}}let z=Dt({mapPath:g,transtype:D,outputDir:y,cssArg:Z,ditavalFile:S}),W=h.window.createOutputChannel("DITA-OT Transform");p.push(h.Disposable.from({dispose:()=>W.dispose()},{dispose:()=>l.dispose()})),W.show(!0),await h.window.withProgress({location:h.ProgressLocation.Notification,title:`DITA-OT: \u6B63\u5728\u8F6C\u6362\u4E3A ${D}\uFF08\u9996\u6B21\u8F6C\u6362\u53EF\u80FD\u9700\u8981\u8F83\u957F\u65F6\u95F4\uFF09`,cancellable:!0},async(c,q)=>(q.onCancellationRequested(()=>{l.token.isCancellationRequested||l.cancel()}),new Promise((O,M)=>{let se=process.platform==="win32",oe=(0,Ct.spawn)(v.location.executablePath,z,{shell:se}),be=!1,R=l.token.onCancellationRequested(()=>{be=!0,oe.kill("SIGTERM"),setTimeout(()=>{try{oe.kill("SIGKILL")}catch{}},3e3)});p.push(R);let J=0,pe=St();oe.stdout?.on("data",B=>{W.append(B.toString())}),oe.stderr?.on("data",B=>{let te=B.toString();W.append(te);let E=pe.processChunk(te);for(let ue of E)ze(ue)==="error"&&J++}),oe.on("error",B=>{W.appendLine(`
[DITA-OT] \u8FDB\u7A0B\u542F\u52A8\u5931\u8D25: ${B.message}`),M(B)}),oe.on("close",async B=>{for(let E of pe.flush())ze(E)==="error"&&J++;if(be){W.appendLine(`
