...
export function sharedWebviewStrings() {
  return {
    ...
    tagTooltipsLabel: JSON.stringify(vscode.l10n.t('Tags')),
    tagTooltipsOnTitle: JSON.stringify(vscode.l10n.t('Element tag names are shown as hover tooltips. Click to hide them.')),
    tagTooltipsOffTitle: JSON.stringify(vscode.l10n.t('Element tag names are hidden. Click to show each element\'s tag name on hover.')),
