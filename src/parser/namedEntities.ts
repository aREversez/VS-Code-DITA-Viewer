/**
 * Named character entities beyond the XML built-ins, for preprocessEntities
 * (ditaParser.ts). DITA topics written against the OASIS DTDs use the ISO 8879
 * entity sets (&le; &ge; &alpha; &rArr; &thinsp; ...) that the DTD's external
 * subset would normally declare; that subset is never loaded here, so without
 * a table the references would be unresolvable.
 *
 * Generated from the HTML5 named-character-reference list (a superset of the
 * ISO 8879 sets with the same code points for the shared names), minus the
 * five XML built-ins that need no substitution. One compact "name=HEX[+HEX]"
 * blob rather than an object literal, parsed once on first use.
 */
const ENTITY_BLOB =
  ...
  'amacr=101,amalg=2A3F,and=2227,andand=2A55,andd=2A5C,andslope=2A58,andv=2A5A,ang=2220,ange=29A4,' +
  'angle=2220,angmsd=2221,angmsdaa=29A8,angmsdab=29A9,angmsdac=29AA,angmsdad=29AB,angmsdae=29AC,' +
  'angmsdaf=29AD,angmsdag=29AE,angmsdah=29AF,angrt=221F,angrtvb=22BE,angrtvbd=299D,angsph=2222,' +
  'angst=C5,angzarr=237C,aogon=105,aopf=1D552,ap=2248,apE=2A70,apacir=2A6F,ape=224A,apid=224B,' +
  ...
  'bdquo=201E,becaus=2235,because=2235,bemptyv=29B0,bepsi=3F6,bernou=212C,beta=3B2,beth=2136,' +
  'between=226C,bfr=1D51F,bigcap=22C2,bigcirc=25EF,bigcup=22C3,bigodot=2A00,bigoplus=2A01,' +
  'bigotimes=2A02,bigsqcup=2A06,bigstar=2605,bigtriangledown=25BD,bigtriangleup=25B3,biguplus=2A04,' +
  'bigvee=22C1,bigwedge=22C0,bkarow=290D,blacklozenge=29EB,blacksquare=25AA,blacktriangle=25B4,' +
  'blacktriangledown=25BE,blacktriangleleft=25C2,blacktriangleright=25B8,blank=2423,blk12=2592,' +
  'blk14=2591,blk34=2593,block=2588,bne=3D+20E5,bnequiv=2261+20E5,bnot=2310,bopf=1D553,bot=22A5,' +
  'bottom=22A5,bowtie=22C8,boxDL=2557,boxDR=2554,boxDl=2556,boxDr=2553,boxH=2550,boxHD=2566,' +
  'boxHU=2569,boxHd=2564,boxHu=2567,boxUL=255D,boxUR=255A,boxUl=255C,boxUr=2559,boxV=2551,' +
  'boxVH=256C,boxVL=2563,boxVR=2560,boxVh=256B,boxVl=2562,boxVr=255F,boxbox=29C9,boxdL=2555,' +
  'boxdR=2552,boxdl=2510,boxdr=250C,boxh=2500,boxhD=2565,boxhU=2568,boxhd=252C,boxhu=2534,' +
  'boxminus=229F,boxplus=229E,boxtimes=22A0,boxuL=255B,boxuR=2558,boxul=2518,boxur=2514,boxv=2502,' +
  'boxvH=256A,boxvL=2561,boxvR=255E,boxvh=253C,boxvl=2524,boxvr=251C,bprime=2035,breve=2D8,' +
  ...
  'copysr=2117,crarr=21B5,cross=2717,cscr=1D4B8,csub=2ACF,csube=2AD1,csup=2AD0,csupe=2AD2,' +
  ...
  'empty=2205,emptyset=2205,emptyv=2205,emsp13=2004,emsp14=2005,emsp=2003,eng=14B,ensp=2002,' +
  'eogon=119,eopf=1D556,epar=22D5,eparsl=29E3,eplus=2A71,epsi=3B5,epsilon=3B5,epsiv=3F5,eqcirc=2256,' +
  'eqcolon=2255,eqsim=2242,eqslantgtr=2A96,eqslantless=2A95,equals=3D,equest=225F,equiv=2261,' +
  'equivDD=2A78,eqvparsl=29E5,erDot=2253,erarr=2971,escr=212F,esdot=2250,esim=2242,eta=3B7,eth=F0,' +
  'euml=EB,euro=20AC,excl=21,exist=2203,expectation=2130,exponentiale=2147,fallingdotseq=2252,' +
  'fcy=444,female=2640,ffilig=FB03,fflig=FB00,ffllig=FB04,ffr=1D523,filig=FB01,fjlig=66+6A,' +
  'flat=266D,fllig=FB02,fltns=25B1,fnof=192,fopf=1D557,forall=2200,fork=22D4,forkv=2AD9,' +
  'fpartint=2A0D,frac12=BD,frac13=2153,frac14=BC,frac15=2155,frac16=2159,frac18=215B,frac23=2154,' +
  'frac25=2156,frac34=BE,frac35=2157,frac38=215C,frac45=2158,frac56=215A,frac58=215D,frac78=215E,' +
  'frasl=2044,frown=2322,fscr=1D4BB,gE=2267,gEl=2A8C,gacute=1F5,gamma=3B3,gammad=3DD,gap=2A86,' +
  'gbreve=11F,gcirc=11D,gcy=433,gdot=121,ge=2265,gel=22DB,geq=2265,geqq=2267,geqslant=2A7E,ges=2A7E,' +
  'gescc=2AA9,gesdot=2A80,gesdoto=2A82,gesdotol=2A84,gesl=22DB+FE00,gesles=2A94,gfr=1D524,gg=226B,' +
  'ggg=22D9,gimel=2137,gjcy=453,gl=2277,glE=2A92,gla=2AA5,glj=2AA4,gnE=2269,gnap=2A8A,gnapprox=2A8A,' +
  'gne=2A88,gneq=2A88,gneqq=2269,gnsim=22E7,gopf=1D558,grave=60,gscr=210A,gsim=2273,gsime=2A8E,' +
  'gsiml=2A90,gtcc=2AA7,gtcir=2A7A,gtdot=22D7,gtlPar=2995,gtquest=2A7C,gtrapprox=2A86,gtrarr=2978,' +
  'gtrdot=22D7,gtreqless=22DB,gtreqqless=2A8C,gtrless=2277,gtrsim=2273,gvertneqq=2269+FE00,' +
  'gvnE=2269+FE00,hArr=21D4,hairsp=200A,half=BD,hamilt=210B,hardcy=44A,harr=2194,harrcir=2948,' +
  'harrw=21AD,hbar=210F,hcirc=125,hearts=2665,heartsuit=2665,hellip=2026,hercon=22B9,hfr=1D525,' +
  'hksearow=2925,hkswarow=2926,hoarr=21FF,homtht=223B,hookleftarrow=21A9,hookrightarrow=21AA,' +
  'hopf=1D559,horbar=2015,hscr=1D4BD,hslash=210F,hstrok=127,hybull=2043,hyphen=2010,iacute=ED,' +
  'ic=2063,icirc=EE,icy=438,iecy=435,iexcl=A1,iff=21D4,ifr=1D526,igrave=EC,ii=2148,iiiint=2A0C,' +
  'iiint=222D,iinfin=29DC,iiota=2129,ijlig=133,imacr=12B,image=2111,imagline=2110,imagpart=2111,' +
  'imath=131,imof=22B7,imped=1B5,in=2208,incare=2105,infin=221E,infintie=29DD,inodot=131,int=222B,' +
  'intcal=22BA,integers=2124,intercal=22BA,intlarhk=2A17,intprod=2A3C,iocy=451,iogon=12F,iopf=1D55A,' +
  'iota=3B9,iprod=2A3C,iquest=BF,iscr=1D4BE,isin=2208,isinE=22F9,isindot=22F5,isins=22F4,' +
  'isinsv=22F3,isinv=2208,it=2062,itilde=129,iukcy=456,iuml=EF,jcirc=135,jcy=439,jfr=1D527,' +
  'jmath=237,jopf=1D55B,jscr=1D4BF,jsercy=458,jukcy=454,kappa=3BA,kappav=3F0,kcedil=137,kcy=43A,' +
  'kfr=1D528,kgreen=138,khcy=445,kjcy=45C,kopf=1D55C,kscr=1D4C0,lAarr=21DA,lArr=21D0,lAtail=291B,' +
  'lBarr=290E,lE=2266,lEg=2A8B,lHar=2962,lacute=13A,laemptyv=29B4,lagran=2112,lambda=3BB,lang=27E8,' +
  'langd=2991,langle=27E8,lap=2A85,laquo=AB,larr=2190,larrb=21E4,larrbfs=291F,larrfs=291D,' +
  'larrhk=21A9,larrlp=21AB,larrpl=2939,larrsim=2973,larrtl=21A2,lat=2AAB,latail=2919,late=2AAD,' +
  'lates=2AAD+FE00,lbarr=290C,lbbrk=2772,lbrace=7B,lbrack=5B,lbrke=298B,lbrksld=298F,lbrkslu=298D,' +
  'lcaron=13E,lcedil=13C,lceil=2308,lcub=7B,lcy=43B,ldca=2936,ldquo=201C,ldquor=201E,ldrdhar=2967,' +
  ...
  'lsqb=5B,lsquo=2018,lsquor=201A,lstrok=142,ltcc=2AA6,ltcir=2A79,ltdot=22D6,lthree=22CB,' +
  ...
  'quaternions=210D,quatint=2A16,quest=3F,questeq=225F,rAarr=21DB,rArr=21D2,rAtail=291C,rBarr=290F,' +
  'rHar=2964,race=223D+331,racute=155,radic=221A,raemptyv=29B3,rang=27E9,rangd=2992,range=29A5,' +
  'rangle=27E9,raquo=BB,rarr=2192,rarrap=2975,rarrb=21E5,rarrbfs=2920,rarrc=2933,rarrfs=291E,' +
  'rarrhk=21AA,rarrlp=21AC,rarrpl=2945,rarrsim=2974,rarrtl=21A3,rarrw=219D,ratail=291A,ratio=2236,' +
  'rationals=211A,rbarr=290D,rbbrk=2773,rbrace=7D,rbrack=5D,rbrke=298C,rbrksld=298E,rbrkslu=2990,' +
  'rcaron=159,rcedil=157,rceil=2309,rcub=7D,rcy=440,rdca=2937,rdldhar=2969,rdquo=201D,rdquor=201D,' +
  'rdsh=21B3,real=211C,realine=211B,realpart=211C,reals=211D,rect=25AD,reg=AE,rfisht=297D,' +
  'rfloor=230B,rfr=1D52F,rhard=21C1,rharu=21C0,rharul=296C,rho=3C1,rhov=3F1,rightarrow=2192,' +
  ...
  'scedil=15F,scirc=15D,scnE=2AB6,scnap=2ABA,scnsim=22E9,scpolint=2A13,scsim=227F,scy=441,sdot=22C5,' +
  'sdotb=22A1,sdote=2A66,seArr=21D8,searhk=2925,searr=2198,searrow=2198,sect=A7,semi=3B,seswar=2929,' +
  ...
  'simrarr=2972,slarr=2190,smallsetminus=2216,smashp=2A33,smeparsl=29E4,smid=2223,smile=2323,' +
  'smt=2AAA,smte=2AAC,smtes=2AAC+FE00,softcy=44C,sol=2F,solb=29C4,solbar=233F,sopf=1D564,' +
  'spades=2660,spadesuit=2660,spar=2225,sqcap=2293,sqcaps=2293+FE00,sqcup=2294,sqcups=2294+FE00,' +
  'sqsub=228F,sqsube=2291,sqsubset=228F,sqsubseteq=2291,sqsup=2290,sqsupe=2292,sqsupset=2290,' +
  'sqsupseteq=2292,squ=25A1,square=25A1,squarf=25AA,squf=25AA,srarr=2192,sscr=1D4C8,ssetmn=2216,' +
  'ssmile=2323,sstarf=22C6,star=2606,starf=2605,straightepsilon=3F5,straightphi=3D5,strns=AF,' +
  'sub=2282,subE=2AC5,subdot=2ABD,sube=2286,subedot=2AC3,submult=2AC1,subnE=2ACB,subne=228A,' +
  'subplus=2ABF,subrarr=2979,subset=2282,subseteq=2286,subseteqq=2AC5,subsetneq=228A,' +
  'subsetneqq=2ACB,subsim=2AC7,subsub=2AD5,subsup=2AD3,succ=227B,succapprox=2AB8,succcurlyeq=227D,' +
  'succeq=2AB0,succnapprox=2ABA,succneqq=2AB6,succnsim=22E9,succsim=227F,sum=2211,sung=266A,sup1=B9,' +
  'sup2=B2,sup3=B3,sup=2283,supE=2AC6,supdot=2ABE,supdsub=2AD8,supe=2287,supedot=2AC4,suphsol=27C9,' +
  'suphsub=2AD7,suplarr=297B,supmult=2AC2,supnE=2ACC,supne=228B,supplus=2AC0,supset=2283,' +
  'supseteq=2287,supseteqq=2AC6,supsetneq=228B,supsetneqq=2ACC,supsim=2AC8,supsub=2AD4,supsup=2AD6,' +
  'swArr=21D9,swarhk=2926,swarr=2199,swarrow=2199,swnwar=292A,szlig=DF,target=2316,tau=3C4,' +
  'tbrk=23B4,tcaron=165,tcedil=163,tcy=442,tdot=20DB,telrec=2315,tfr=1D531,there4=2234,' +
  ...
  'utrif=25B4,uuarr=21C8,uuml=FC,uwangle=29A7,vArr=21D5,vBar=2AE8,vBarv=2AE9,vDash=22A8,vangrt=299C,' +
  'varepsilon=3F5,varkappa=3F0,varnothing=2205,varphi=3D5,varpi=3D6,varpropto=221D,varr=2195,' +
  'varrho=3F1,varsigma=3C2,varsubsetneq=228A+FE00,varsubsetneqq=2ACB+FE00,varsupsetneq=228B+FE00,' +
  'varsupsetneqq=2ACC+FE00,vartheta=3D1,vartriangleleft=22B2,vartriangleright=22B3,vcy=432,' +
  'vdash=22A2,vee=2228,veebar=22BB,veeeq=225A,vellip=22EE,verbar=7C,vert=7C,vfr=1D533,vltri=22B2,' +
  'vnsub=2282+20D2,vnsup=2283+20D2,vopf=1D567,vprop=221D,vrtri=22B3,vscr=1D4CB,vsubnE=2ACB+FE00,' +
  'vsubne=228A+FE00,vsupnE=2ACC+FE00,vsupne=228B+FE00,vzigzag=299A,wcirc=175,wedbar=2A5F,wedge=2227,' +
  'wedgeq=2259,weierp=2118,wfr=1D534,wopf=1D568,wp=2118,wr=2240,wreath=2240,wscr=1D4CC,xcap=22C2,' +
  'xcirc=25EF,xcup=22C3,xdtri=25BD,xfr=1D535,xhArr=27FA,xharr=27F7,xi=3BE,xlArr=27F8,xlarr=27F5,' +
  'xmap=27FC,xnis=22FB,xodot=2A00,xopf=1D569,xoplus=2A01,xotime=2A02,xrArr=27F9,xrarr=27F6,' +
  'xscr=1D4CD,xsqcup=2A06,xuplus=2A04,xutri=25B3,xvee=22C1,xwedge=22C0,yacute=FD,yacy=44F,ycirc=177,' +
  'ycy=44B,yen=A5,yfr=1D536,yicy=457,yopf=1D56A,yscr=1D4CE,yucy=44E,yuml=FF,zacute=17A,zcaron=17E,' +
  'zcy=437,zdot=17C,zeetrf=2128,zeta=3B6,zfr=1D537,zhcy=436,zigrarr=21DD,zopf=1D56B,zscr=1D4CF,' +
  'zwj=200D,zwnj=200C';

let table: Map<string, string> | undefined;

/** The literal character(s) for a named entity, or undefined if unknown. */
export function lookupNamedEntity(name: string): string | undefined {
  if (!table) {
    table = new Map();
    for (const pair of ENTITY_BLOB.split(',')) {
      const eq = pair.indexOf('=');
      if (eq < 0) continue;
      table.set(pair.slice(0, eq), pair.slice(eq + 1).split('+').map((h) => String.fromCodePoint(parseInt(h, 16))).join(''));
    }
  }
